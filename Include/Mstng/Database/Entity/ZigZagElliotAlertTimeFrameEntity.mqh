...
#ifndef MSTNG_DATABASE_ENTITY_ZZ_ELLIOT_ALERT_TF_ENTITY_MQH
#define MSTNG_DATABASE_ENTITY_ZZ_ELLIOT_ALERT_TF_ENTITY_MQH

/**
 * ZigZagElliotアラートの時間足別分析スナップショット。
 *
 * DAOが保存する論理列順にフィールドを定義する。
 */
struct ZigZagElliotAlertTimeFrameEntity {
    /** 時間足別分析ID。 */
    long id;
...
#endif // MSTNG_DATABASE_ENTITY_ZZ_ELLIOT_ALERT_TF_ENTITY_MQH
