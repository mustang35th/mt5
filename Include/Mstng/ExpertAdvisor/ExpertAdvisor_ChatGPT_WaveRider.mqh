//+------------------------------------------------------------------+
//|                              ExpertAdvisor_ChatGPT_WaveRider.mqh |
...
class ExpertAdvisor_ChatGPT_WaveRider : public AbstractExpertAdvisor {
public:
    
    ExpertAdvisor_ChatGPT_WaveRider(string fromSymbolName, ENUM_TIMEFRAMES fromTimeFrame, bool fromIsDrawArrow = true) {
        ...
        this.name = "ChatGPT_WaveRider";
        this.fontSize = 20;
    }
    
    ~ExpertAdvisor_ChatGPT_WaveRider() {
    }
