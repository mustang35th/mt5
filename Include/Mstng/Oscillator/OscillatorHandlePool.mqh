...
/**
 * 3種類の StochasticHandlePool と GmmaHandlePool と Ema200HandlePool と AverageTrueRangeHandlePool を包括して管理するクラス。
 *
 * - Short  : 5,3,3
 * - Middle : 14,3,3
 * - Long   : 21,5,5
