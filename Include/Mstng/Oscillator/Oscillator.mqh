...
public:
    ...
    bool update(string fromSymbolName, ENUM_TIMEFRAMES fromTimeFrame, int fromDigits, OscillatorHandlePool *oscillatorHandlePool) {
        ...
        return this.update(context, oscillatorHandlePool);
    }
    ...
    string toString() {
        ...
        result += ", ema30=" + this.getEma30Text(this.marketContext.digits);
        result += ", ema60=" + this.getEma60Text(this.marketContext.digits);
...
private:
    ...
    string getGmmaCsv() {
        ...
        ) + this.getEmaCsv(this.marketContext.digits, 1);
    }
    ...
    bool setGmma(OscillatorHandlePool *oscillatorHandlePool) {
        ...
        if (!gmma.getTrendCount(this.marketContext, trendCount)) {
            this.logger.error(__FUNCTION__, "gmma.getTrendCount failed.");
            return false;
        }

        if (!gmma.getCrossCount(this.marketContext, crossCount)) {
